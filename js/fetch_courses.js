    ...
    fetch('http://asaberglund.se/rest-projekt/courses.php')
        ...
        .then(data => {
            data.forEach(course => {
                ...
                coursesEl.innerHTML +=
                    "<div class='item'><p>" +
                    "<b>Namn: </b>" + course.name + "<br><br>" +
                    "<b> Universitet:</b> "+ course.university+" <br><br>" +
                    "<b>Beskrivning: </b>" + course.description + "<br><br>" +
                    "<b>Kursplan: </b>" + course.link + "<br><br>" +
                    "<b>Id: </b>" + course.id + "<br><br>" +
